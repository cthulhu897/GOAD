...
failed: [192.168.10.11] (item={'key': 'arya.stark', 'value': {'firstname': 'Arya', 'surname': 'Stark',
...
...
fatal: [192.168.10.10]: FAILED! => {"msg": "winrm or requests is not installed: No module named winrm"}
